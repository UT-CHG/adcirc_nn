...
################################################################################
def adcirc_init_elev_bc_from_nn_hydrograph(anns): # anns is an AdcircNN_class object
...
################################################################################
def adcirc_init_flux_bc_from_nn_hydrograph(anns): # anns is an AdcircNN_class object
